...
require_once 'config.php';
    if(isset($_POST["login"])){
        ...
        $sql = mysqli_query($conn, "SELECT tbl_users.isAdmin,tbl_users.password, tbl_users.status,s.ID as student_id FROM tbl_users INNER JOIN tbl_student as s on tbl_users.studentID = s.ID  where tbl_users.email = '$email'");
...
<nav class="navbar navbar-expand-lg navbar-light navbar-laravel">
    <div class="container">
        <a class="navbar-brand" href="#">Register sa una ug admin sir Bra</a>
